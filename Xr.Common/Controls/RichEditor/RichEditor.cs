...
namespace Xr.Common.Controls
{
    ...
    public partial class RichEditor : UserControl
    {
        ...
        private void toolStripButtonPicture_Click( object sender, EventArgs e )
        {
            ...
            f.ShowDialog();
            f.Dispose();
            String src = "http://www.people.com.cn/h/pic/20140918/69/4985902989970457161.jpg";
            Object obj = "<div><img src='" + src + "' style='width:100px; height:100px;'></div>";
            webBrowserBody.Document.ExecCommand("inserthtml", false, obj);
        }
