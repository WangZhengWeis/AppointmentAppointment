...
{
    public partial class FunctionForm : UserControl
    {
        public FunctionForm()
        {
            InitializeComponent();
        ...
        private void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            {
                var selectedRow = gridView1.GetFocusedRow() as FunctionEntity;
                if (selectedRow == null)
                    return;
                var edit = new FunctionEdit();
                edit.function = selectedRow;
                edit.Text = "功能修改";
                if (edit.ShowDialog() == DialogResult.OK)
                {
                    Thread.Sleep(300);
        ...
        private void repositoryItemButtonEdit2_Click(object sender, EventArgs e)
        {
                ...
                MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MainForm) == DialogResult.OK)
            {
                ...
                String url = AppContext.AppConfig.serverUrl + "sys/function/delete" + param;
                cmd.ShowOpaqueLayer();
                this.DoWorkAsync(500, (o) => //耗时逻辑处理(此处不能操作UI控件，因为是在异步中)
                {
                    String data = HttpClass.httpPost(url);
