...
namespace Xr.RtScreen.Models
{
    ...
    public static class RestSharpHelper
    {
        ...
        /// RestSharp请求
        /// </summary>
        /// <typeparam name="T">List<string></string>
        /// <param name="Url">请求地址</param>
        /// <param name="prament">请求参数</param>
        /// <param name="methoh">请求方式(GET, POST, PUT, HEAD, OPTIONS, DELETE)</param>
        /// <param name="callback">回调函数</param>
        /// </typeparam>
        public static void ReturnResult<T>(string Url, Dictionary<string, string> prament, Method methoh, Action<IRestResponse<T>> callback)
            where T: new()
        {
